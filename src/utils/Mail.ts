                                                                 ...
                                                                 <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                                    ...
                                                                    <tr style="border-collapse:collapse">
                                                                       <td align="left" bgcolor="#fff" style="Margin:0;padding-top:20px;padding-bottom:20px;padding-left:30px;padding-right:30px">
                                                                          <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#000000">Hi "${userInfo.userName}" ,<br><br>Welcome to your BioLabs Connect&nbsp<br><br>Your account has been created and is ready for your use. Click below button to set your password and get going.</p>
                                                                       </td>
                                                                    </tr>
                                                                    <tr style="border-collapse:collapse">
                                                                       <td align="center" bgcolor="#fff" style="padding:0;Margin:0;padding-left:30px;padding-right:30px">
                                                                          ...
                                                                          <a href="" target="_blank">
                                                                             <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" stripoVmlButton href="" 
                                                                                style="height:49px;v-text-anchor:middle;width:469px;" arcsize="6%" strokecolor="#2a289d" fillcolor="#2a289d">
                                                                                <w:anchorlock></w:anchorlock>
                                                                                <center style='color:#ffffff;font-family:lato, "helvetica neue", helvetica, arial, sans-serif;font-size:16px;font-weight:400;'><b style="color:white;">Confirm your Email Address</b></center>
                                                                             </v:roundrect>
                                                                          </a>
                                                                          <![endif]--> 
                                                                          <!--[if !mso]><!-- --><span class="msohide es-button-border es-button-border-3" style="border-style:solid;border-color:#2A289D;background:#2A289D;border-width:1px;display:block;border-radius:3px;width:auto;mso-hide:all"><a href="${EMAIL.EMAIL_CONFIRM_URL + userInfo.token}" class="es-button msohide" target="_blank" style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;font-size:16px;color:#FFFFFF;border-style:solid;border-color:#2A289D;border-width:15px 20px;display:block;background:#2A289D;border-radius:3px;font-weight:normal;font-style:normal;line-height:19px;width:auto;text-align:center;mso-hide:all">Confirm your Email Address</a></span> 
                                                                          <!--<![endif]-->
                                                                       </td>
                                                                    </tr>
                                                                    <tr style="border-collapse:collapse">
